...
class LibraryComparisonController extends Controller {
  ...
  public function index() {
    ...
    $models           = Device::select('computer_model_id')->distinct()->orderBy('computer_model_id')->pluck('computer_model_id');
    $incomingStatuses = $this->incomingStatusOptions();
    $results          = session('lc_results');

    return view('checkouts.library-comparison.index', compact(
